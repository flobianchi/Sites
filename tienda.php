...
$query = "SELECT tiendas.id, tiendas.nombre, direcciones.nombre_direccion FROM tiendas JOIN direcciones ON tiendas.direccion = direcciones.id ORDER BY tiendas.id;";
