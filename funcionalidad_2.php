...
Consultar productos aqui
 ...
 $query = "SELECT * FROM productos JOIN disponibilidad_tienda ON productos.id = disponibilidad_tienda.id_producto WHERE disponibilidad_tienda.id_tienda = $id AND LOWER(productos.nombre) LIKE LOWER ('%$f2%');";
